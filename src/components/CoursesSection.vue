    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- <a href="#" class="btn btn-dark p-1">_</a> -->
              </div>
            </div>
          </div>
          <div class="col-sm-3">
          ...
          <div class="col-sm-3">
            <div class="card">
              <img src="../../public/git.svg" class="card-img-top" alt="..." />
              <div class="card-body">
          ...
          <div class="col-sm-3">
            <div class="card">
              <img src="../../public/sql.svg" class="card-img-top" alt="..." />
              <div class="card-body">
